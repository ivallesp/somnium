...
class TestNormalization(TestCase):
    ...
    def test_standard_normalizer(self):
        ...
        self.assertTrue(np.any(data_norm != data_denorm))
        self.assertTrue(np.any(data_norm_by != data_denorm_by))
        ...
        self.assertTrue(np.any(data_norm != data_norm_by))
    ...
    def test_log_normalizer(self):
        ...
        self.assertTrue(np.all(data_norm == data_norm_by))
